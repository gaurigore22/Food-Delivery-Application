...
export class CustomerserviceService {
  ...
  private custURL="http://localhost:8080/customer/showorderlist";
   private custsave="http://localhost:8080/customer/createneworder";
   private custdel="http://localhost:8080/customer/deletemyorder";
   private custupdate="http://localhost:8080/customer/updateOrder";
   private custfind="http://localhost:8080/customer/findmyorder";
